...
namespace Projet2_5B6
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="BD5B6TP2_ConstantinMenardS")]
    ...
    partial void InsertPrixDepenseAbonnement(PrixDepenseAbonnement instance);
    partial void UpdatePrixDepenseAbonnement(PrixDepenseAbonnement instance);
    partial void DeletePrixDepenseAbonnement(PrixDepenseAbonnement instance);
    ...
    partial void InsertTypeAbonnement(TypeAbonnement instance);
    partial void UpdateTypeAbonnement(TypeAbonnement instance);
    partial void DeleteTypeAbonnement(TypeAbonnement instance);
    ...
    partial void DeleteEmploye(Employe instance);
		...
		public DataClasses1DataContext() : 
				base(global::Projet2_5B6.Properties.Settings.Default.BD5B6TP2_ConstantinMenardSConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<PrixDepenseAbonnement> PrixDepenseAbonnements
		{
			get
			{
				return this.GetTable<PrixDepenseAbonnement>();
			}
		}
		...
		public System.Data.Linq.Table<TypeAbonnement> TypeAbonnements
		{
			get
			{
				return this.GetTable<TypeAbonnement>();
			}
		}
	...
	public partial class Abonnement : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<TypeAbonnement> _TypeAbonnement;
    ...
    partial void OnCellulaireChanging(int value);
    ...
    partial void OnRemarqueChanged();
		...
		public Abonnement()
		{
			...
			this._TypeAbonnement = default(EntityRef<TypeAbonnement>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Cellulaire", DbType="Int NOT NULL")]
		public int Cellulaire
		{
			get
			{
		...
		public int NoTypeAbonnement
		{
			...
			set
			{
				...
				{
					if (this._TypeAbonnement.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Remarque", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Abonnement_PartiesJouee", Storage="_PartiesJouees", ThisKey="Id", OtherKey="IdAbbonement")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Abonnement_Reabonnement", Storage="_Reabonnements", ThisKey="Id", OtherKey="IdAbbonement")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeAbonnement_Abonnement", Storage="_TypeAbonnement", ThisKey="NoTypeAbonnement", OtherKey="No", IsForeignKey=true)]
		public TypeAbonnement TypeAbonnement
		{
			get
			{
				return this._TypeAbonnement.Entity;
			}
			set
			{
				TypeAbonnement previousValue = this._TypeAbonnement.Entity;
				if (((previousValue != value) 
							|| (this._TypeAbonnement.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TypeAbonnement.Entity = null;
						previousValue.Abonnements.Remove(this);
					}
					this._TypeAbonnement.Entity = value;
					if ((value != null))
					{
						value.Abonnements.Add(this);
					...
					this.SendPropertyChanged("TypeAbonnement");
				}
			}
		}
    ...
    partial void OnRemarqueChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Remarque", DbType="NVarChar(100)")]
		public string Remarque
		{
			get
			{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnIdAbbonementChanging(string value);
    partial void OnIdAbbonementChanged();
    ...
    partial void OnRemarqueChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdAbbonement", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string IdAbbonement
		{
			get
			{
				return this._IdAbbonement;
			}
			set
			{
				if ((this._IdAbbonement != value))
				{
					if (this._Abonnement.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnIdAbbonementChanging(value);
					this.SendPropertyChanging();
					this._IdAbbonement = value;
					this.SendPropertyChanged("IdAbbonement");
					this.OnIdAbbonementChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Abonnement_PartiesJouee", Storage="_Abonnement", ThisKey="IdAbbonement", OtherKey="Id", IsForeignKey=true)]
		public Abonnement Abonnement
		{
			get
			{
			...
			set
			{
							...
							|| (this._Abonnement.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._IdAbbonement = value.Id;
					}
					else
					{
						this._IdAbbonement = default(string);
					}
					this.SendPropertyChanged("Abonnement");
				}
			}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PrixDepenseAbonnements")]
	public partial class PrixDepenseAbonnement : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _Anne;
		
		private decimal _Prix;
		
		private decimal _DepenseObligatoire;
    ...
    partial void OnNoTypeAbonnementChanging(int value);
    partial void OnNoTypeAbonnementChanged();
    partial void OnAnneChanging(System.DateTime value);
    partial void OnAnneChanged();
    partial void OnPrixChanging(decimal value);
    partial void OnPrixChanged();
    partial void OnDepenseObligatoireChanging(decimal value);
    partial void OnDepenseObligatoireChanged();
    partial void OnRemarqueChanging(string value);
    partial void OnRemarqueChanged();
    #endregion
		
		public PrixDepenseAbonnement()
		{
			this._TypeAbonnement = default(EntityRef<TypeAbonnement>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Anne", DbType="Date NOT NULL", IsPrimaryKey=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DepenseObligatoire", DbType="Money NOT NULL")]
		public decimal DepenseObligatoire
		{
			get
			{
				return this._DepenseObligatoire;
			}
			set
			{
				if ((this._DepenseObligatoire != value))
				{
					this.OnDepenseObligatoireChanging(value);
					this.SendPropertyChanging();
					this._DepenseObligatoire = value;
					this.SendPropertyChanged("DepenseObligatoire");
					this.OnDepenseObligatoireChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeAbonnement_PrixDepenseAbonnement", Storage="_TypeAbonnement", ThisKey="NoTypeAbonnement", OtherKey="No", IsForeignKey=true)]
		public TypeAbonnement TypeAbonnement
		{
			get
			{
			...
			set
			{
							...
							|| (this._TypeAbonnement.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._TypeAbonnement.Entity = null;
						previousValue.PrixDepenseAbonnements.Remove(this);
					}
					this._TypeAbonnement.Entity = value;
					if ((value != null))
					{
						value.PrixDepenseAbonnements.Add(this);
						this._NoTypeAbonnement = value.No;
					}
					else
					{
    ...
    partial void OnRemarqueChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Abonnement_Reabonnement", Storage="_Abonnement", ThisKey="IdAbbonement", OtherKey="Id", IsForeignKey=true)]
		public Abonnement Abonnement
		{
			get
			{
    ...
    partial void OnNoEmpleChanging(int value);
    partial void OnNoEmpleChanged();
    partial void OnRemarqueChanging(string value);
    partial void OnRemarqueChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NoEmple", DbType="Int NOT NULL")]
		public int NoEmple
		{
			get
			{
				return this._NoEmple;
			}
			set
			{
				if ((this._NoEmple != value))
				{
					if (this._Employe.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnNoEmpleChanging(value);
					this.SendPropertyChanging();
					this._NoEmple = value;
					this.SendPropertyChanged("NoEmple");
					this.OnNoEmpleChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employe_Service", Storage="_Employe", ThisKey="NoEmple", OtherKey="No", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Employe.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._NoEmple = value.No;
					}
					else
					{
						this._NoEmple = default(int);
					}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TypeAbonnement")]
	public partial class TypeAbonnement : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<PrixDepenseAbonnement> _PrixDepenseAbonnements;
    ...
    partial void OnRemarqueChanged();
		...
		{
			this._Abonnements = new EntitySet<Abonnement>(new Action<Abonnement>(this.attach_Abonnements), new Action<Abonnement>(this.detach_Abonnements));
			this._PrixDepenseAbonnements = new EntitySet<PrixDepenseAbonnement>(new Action<PrixDepenseAbonnement>(this.attach_PrixDepenseAbonnements), new Action<PrixDepenseAbonnement>(this.detach_PrixDepenseAbonnements));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeAbonnement_Abonnement", Storage="_Abonnements", ThisKey="No", OtherKey="NoTypeAbonnement")]
		public EntitySet<Abonnement> Abonnements
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeAbonnement_PrixDepenseAbonnement", Storage="_PrixDepenseAbonnements", ThisKey="No", OtherKey="NoTypeAbonnement")]
		public EntitySet<PrixDepenseAbonnement> PrixDepenseAbonnements
		{
			get
			{
				return this._PrixDepenseAbonnements;
			}
			set
			{
				this._PrixDepenseAbonnements.Assign(value);
			}
		}
		...
		{
			this.SendPropertyChanging();
			entity.TypeAbonnement = this;
		}
		
		private void detach_Abonnements(Abonnement entity)
		{
			this.SendPropertyChanging();
			entity.TypeAbonnement = null;
		}
		
		private void attach_PrixDepenseAbonnements(PrixDepenseAbonnement entity)
		{
			this.SendPropertyChanging();
			entity.TypeAbonnement = this;
		}
		
		private void detach_PrixDepenseAbonnements(PrixDepenseAbonnement entity)
		{
			this.SendPropertyChanging();
			entity.TypeAbonnement = null;
		}
    ...
    partial void OnTelephoneChanged();
    partial void OnCellulaireChanging(decimal value);
    partial void OnCellulaireChanged();
    partial void OnCourrielChanging(string value);
    partial void OnCourrielChanged();
    ...
    partial void OnRemarqueChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MotDePasse", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Nom", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Nom
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Prenom", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Prenom
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Rue", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Rue
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Ville", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Ville
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Cellulaire", DbType="Decimal(18,0) NOT NULL")]
		public decimal Cellulaire
		{
			get
			{
				return this._Cellulaire;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Courriel", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Courriel
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Remarque", DbType="NVarChar(1) NOT NULL", CanBeNull=false)]
		public string Remarque
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employe_Service", Storage="_Services", ThisKey="No", OtherKey="NoEmple")]
